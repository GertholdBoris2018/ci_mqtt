...
define('BASE_URL', '/');
define('DB_PREFIX', 'avs_');
define('ADMIN',       'A');
define('INVALIDUSER',      'NA');
...
define('FRONTEND_CSS_PATH',BASE_URL.'assets/css/');
define('FRONTEND_JS_PATH',BASE_URL.'assets/js/');
define('FRONTEND_IMAGES_PATH',BASE_URL.'assets/images/');
define('FRONTEND_FONTS_PATH',BASE_URL.'assets/fonts/');
define('IMAGE_UPLOAD_PATH',BASE_URL.'assets/upload/');

define('ADMIN_CSS_PATH',BASE_URL.'assets/admin/stylesheets/');
define('ADMIN_JS_PATH',BASE_URL.'assets/admin/javascripts/');
...
define('ADMIN_SIDEBAR_PORT_CATES' , 'categories');
define('ADMIN_SIDEBAR_PORT_PORTSLIST' , 'portfolios');
define('ADMIN_SIDEBAR_PORT_PORTSADD' , 'addportfolios');
define('ADMIN_SIDEBAR_PORT_PORTSED' , 'editportfolios');
